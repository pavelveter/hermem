...
type Retriever interface {
	...
	MultiHopRetrieveContext(ctx context.Context, vi core.VectorIndex, embedder core.Embedder, seedIDs []string, opts RetrieveContextOptions) (*RetrievalResult, error)
}
