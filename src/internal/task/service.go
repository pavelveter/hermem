...
func (s *Service) Executable(ctx context.Context, goalID string, schema domain.SchemaConfig) ([]domain.Task, error) {
...
func (s *Service) ClaimNextTask(ctx context.Context, goalID string, schema domain.SchemaConfig) (*domain.Task, error) {
...
type TaskShowResult struct {
	Task        domain.Task
	BlockedBy   []domain.Edge
	RecoversVia []domain.Edge
}
...
func (s *Service) Rollback(_ context.Context, id string, schema domain.SchemaConfig) (string, error) {
	if id == "" {
...
func (s *Service) Tree(_ context.Context, goalID string, schema domain.SchemaConfig) (string, error) {
...
func (s *Service) Create(ctx context.Context, id, content string, contextIDs []string, schema domain.SchemaConfig) (string, error) {
	if content == "" {
...
func (s *Service) RecoveryPlan(_ context.Context, id string, schema domain.SchemaConfig) ([]domain.Task, error) {
	if id == "" {
...
func (s *Service) RollbackCascade(_ context.Context, id, errorContext string, schema domain.SchemaConfig) ([]domain.Task, error) {
	if id == "" {
